...
int main()
{
    string test_path = "A:\\T\\3_term\\Operating_Systems\\4lab\\tests\\" + version + "_in.txt";
    ...
    inttime /= 100;
    string result_path = "A:\\T\\3_term\\Operating_Systems\\4lab\\results_prob_right\\" + to_string(TOTAL_THREADS);
